...
from kg_utils_aokvqa_data1 import load_okvqa_data_img, OKVQADatasetImg, img_shape
...
def parse_args():
    ...
    parser.add_argument('--prompt_format', type=str, default='QCM-A', help='prompt format template',
                        choices=['QCM-A', "QCM-EA",'QCM-LE', 'QCMG-A', 'QCM-LEA', 'QCM-ALE', 'QCG-A', 'QC-EA', 'QC-E', 'QC-LE'])
