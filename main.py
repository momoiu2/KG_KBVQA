...
from kg_model4 import T5ForMultimodalGeneration
...
def parse_args():
    ...
    parser.add_argument('--prompt_format', type=str, default='QCM-A', help='prompt format template',
                        choices=['QCM-A', 'QCM-EA', 'QCM-E', 'QCM-LE', 'QCMG-A', 'QCM-LEA', 'QCM-ALE'])
...
def T5Trainer(
    ...
    if args.img_type is not None:
        ...
        model = T5ForMultimodalGeneration.from_pretrained(args.model,patch_size=patch_size,padding_idx=200,save_dir=save_dir)
