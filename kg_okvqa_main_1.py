...
from kg_model4_1 import T5ForConditionalGeneration, T5ForMultimodalGeneration
...
def T5Trainer(
    ...
    if trainer.is_world_process_zero():
        ...
        output_data = {
            ...
            "preds": preds,
            "labels": targets}
        output_prediction_file = os.path.join(save_dir, "okvqa_predictions_ans_test_4.json")
...
if __name__ == '__main__':
    ...
    if args.img_type is not None:
        problems, qids, name_maps, train_image_features, val_image_features, test_image_features = load_okvqa_data_img(
