...
import os
from kg_utils_aokvqa_prompt1 import *
...
def load_okvqa_data_img(args):
    ...
    train_problems = json.load(open(os.path.join(args.data_root, 'a_okvqa/a_okvqa_train_new.json')))  # 问题
    test_problems = json.load(open(os.path.join(args.data_root, 'a_okvqa/a_okvqa_test_new.json')))
    val_problems = json.load(open(os.path.join(args.data_root, 'a_okvqa/a_okvqa_train_new.json')))
    ...
    train_name_maps = json.load(open('data/a_okvqa/vision_features'
                                     '/train_name_map.json'))
    test_name_maps = json.load(open('data/a_okvqa/vision_features'
                                    '/test_name_map.json'))
    val_name_maps = json.load(open('data/a_okvqa/vision_features'
                                   '/train_name_map.json'))
    start = args.start
    end = args.end
    ...
    if args.img_type == "resnet":
        ...
        train_image_features = np.load('data/a_okvqa/vision_features/a_okvqa_clip_train.npy')
        val_image_features = np.load('data/a_okvqa/vision_features/a_okvqa_clip_train.npy')
        test_image_features = np.load('data/a_okvqa/vision_features/a_okvqa_clip_test.npy')
    elif args.img_type == "detr":
        train_image_features = np.load('data/a_okvqa/vision_features/a_okvqa_detr_train.npy')
        val_image_features = np.load('data/a_okvqa/vision_features/a_okvqa_detr_train.npy')
        test_image_features = np.load('data/a_okvqa/vision_features/a_okvqa_detr_train.npy')
    else:
